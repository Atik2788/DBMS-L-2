...
## 📚 টার্মিনালে দেখা সাধারণ প্যাটার্ন

1. **সফল কুয়েরি**: রো সংখ্যা দেখাবে (`(3 rows)`)
2. **ডিলিট/আপডেট**: প্রভাবিত রো সংখ্যা দেখাবে (`DELETE 2`, `UPDATE 3`)
3. **এগ্রিগেট ফাংশন**: একক রো রিটার্ন করে (`(1 row)`)
4. **এরর মেসেজ**: লাল রঙের এরর দেখাবে (`ERROR: column "xyz" does not exist`)

---

🎯 **এবার আপনি টার্মিনালে কমান্ড দিলে কেমন আউটপুট আশা করতে পারেন তা স্পষ্টভাবে বুঝতে পারবেন!**